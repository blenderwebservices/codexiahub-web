        ...
        return $schema
            ->components([
                ...
                Textarea::make('system_prompt')
                    ->label('System Prompt (Chatbot)')
                    ->helperText('Instrucciones del sistema para el chatbot principal.')
                    ->rows(6)
                    ->columnSpanFull(),
                Textarea::make('roi_system_prompt')
                    ->label('System Prompt (Simulador ROI)')
                    ->helperText('Instrucciones para la herramienta de cálculo de ROI.')
                    ->rows(6)
                    ->columnSpanFull(),
                Textarea::make('raci_system_prompt')
                    ->label('System Prompt (Generador RACI)')
                    ->helperText('Instrucciones para la herramienta de clarificación de roles.')
                    ->rows(6)
                    ->columnSpanFull(),
